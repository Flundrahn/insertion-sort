...
public class UnitTests
{
    ...
    public void insertionSort_should_sort_array_of_two()
    {
        ...
        // Act
        var (_, sorted) = Result.insertionSort(testArray);
    ...
    public void insertionSort_should_handle_already_sorted()
    {
        ...
        // Act
        var (_, sorted1) = Result.insertionSort(testArray1);
        var (_, sorted2) = Result.insertionSort(testArray2);
        var (_, sorted3) = Result.insertionSort(testArray3);
    ...
    public void insertionSort_should_handle_multiple_same_values()
    {
        ...
        // Act
        var (_, sorted) = Result.insertionSort(testArray1);
    ...
    public void insertionSort_should_handle_already_sorted_unique_numbers()
    {
        ...
        // Act
        var (numberOfMoves, _) = Result.insertionSort(testArray1);
    ...
    public void insertionSort_should_handle_unordered_multiples()
    {
        ...
        // Act
        var (numberOfMoves, _) = Result.insertionSort(testArray2);
