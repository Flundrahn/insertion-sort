...
public class UnitTests
{
    ...
    {
        // Arrange
        var testArray1 = new List<int> { 1, 2, 3, 4, 5 };

        // Act
        var (numberOfMoves, _) = Result.CountInsertionSort(testArray1);
    ...
    {
        // Arrange
        var testArray1 = new List<int> { 1, 1, 1, 2, 2 };
    ...
    {
        // Arrange
        var testArray2 = new List<int> { 2, 1, 3, 1, 2 };

        // Act
        var (numberOfMoves, _) = Result.CountInsertionSort(testArray2);
